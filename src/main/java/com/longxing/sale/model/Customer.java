...
public class Customer extends BaseEntity implements java.io.Serializable {
	...
	public Customer(java.lang.Long custId) {
		this.custId = custId;
	}
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("CustId", getCustId()).append("CustName", getCustName()).append("Telephone", getTelephone()).toString();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getCustId(), other.getCustId()).isEquals();
	}
}
