...
<rapid:override name="content">
	<form:form method="post" action="${ctx}/core/logon" modelAttribute="authentication">
		...
		<tr>
			...
			<td><form:input path="principal" id="principal" cssClass="" maxlength="64" /> <font color='red'><form:errors path="principal" /> </font>
			</td>
		</tr>
		<tr>
			<td class="tdLabel">Password:</td>
			<td><form:input path="credential" id="credential" cssClass="" maxlength="128" /> <font color='red'><form:errors path="credential" /> </font></td>
		</tr>
