...
<rapid:override name="head">
	...
	<title><%=Procurementsale.TABLE_ALIAS%>新增</title>
</rapid:override>

<rapid:override name="content">
	<form:form method="post" action="${ctx}/procurementsale" modelAttribute="procurementsale" >
	...
	<script>
			function getJsonUrl() {
					return '${ctx}/procurementsale/save.json';
			}
