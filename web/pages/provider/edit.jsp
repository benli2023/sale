...
<rapid:override name="head">
	...
	<title><%=Provider.TABLE_ALIAS%>编辑</title>
</rapid:override>

<rapid:override name="content">
	<form:form method="put" action="${ctx}/provider/${provider.providerId}" modelAttribute="provider">
	...
	<script>
			function getJsonUrl() {
					return '${ctx}/provider/update.json';
			}
